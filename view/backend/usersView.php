                        ...
                        <table class="table table-bordered table-striped table-hover shadow">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" class="align-middle">
                                        <a href="index.php?action=users&orderBy=login&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Login
                                        <?php 
                                        if ($orderBy == "login") {
                                        ?>
                                    ...
                                    <th scope="col" class="align-middle">
                                        <a href="index.php?action=users&orderBy=name&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Nom
                                        <?php 
                                        if ($orderBy == "name") {
                                        ?>
                                            <span class="fas fa-caret-<?= $order == "desc" ? "up" : "down" ?>"></span>
                                    ...
                                    <th scope="col" class="align-middle">
                                        <a href="index.php?action=users&orderBy=surname&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Prénom
                                        <?php 
                                        if ($orderBy == "surname") {
                                        ?>
                                            <span class="fas fa-caret-<?= $order == "desc" ? "up" : "down" ?>"></span>
                                    ...
                                    <th scope="col" class="align-middle">
                                        <a href="index.php?action=users&orderBy=email&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Email
                                        <?php 
                                        if ($orderBy == "email") {
                                        ?>
                                            <span class="fas fa-caret-<?= $order == "desc" ? "up" : "down" ?>"></span>
                                    ...
                                    <th scope="col" class="align-middle">
                                        <a href="index.php?action=users&orderBy=role&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Rôle
                                        <?php 
                                        if ($orderBy == "role") {
                                        ?>
                                            <span class="fas fa-caret-<?= $order == "desc" ? "up" : "down" ?>"></span>
                                    ...
                                    <th scope="col" class="align-middle">
                                        <a href="index.php?action=users&orderBy=registration_date&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Date d'enregistrement
                                        <?php 
