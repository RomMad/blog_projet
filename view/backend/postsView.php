                    ...
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" class="align-middle">
                                <a href="index.php?action=posts&orderBy=title&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Titre
                                <?php 
                                if ($orderBy == "title") {
                                ?>
                            ...
                            <th scope="col" class="align-middle">
                                <a href="index.php?action=posts&orderBy=user_name&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Auteur
                                <?php 
                            ...
                            <th scope="col" class="align-middle">
                                <a href="index.php?action=posts&orderBy=status&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Statut
                                <?php 
                                if ($orderBy == "status") {
                                ?>
                                    <span class="fas fa-caret-<?= $order == "desc" ? "up" : "down" ?>"></span>
                            ...
                            <th scope="col" class="align-middle">
                                <a href="index.php?action=posts&orderBy=creation_date&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Date de création
                                <?php 
                            ...
                            <th scope="col" class="align-middle">
                                <a href="index.php?action=posts&orderBy=update_date&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Date de mise à jour
                                <?php 
