                    ...
                    <div class="col-md-12 col-lg-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="creation_date" class="form-control shadow-sm" id="creation_date"
                                readonly value="<?= isset( $this->_post) ?  $this->_post->creation_date("") : "" ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="update_date" class="form-control shadow-sm" id="update_date"
                                readonly value="<?= isset( $this->_post) ?  $this->_post->update_date("") : "" ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group float-right">
                            ...
                            <?php 
                            if (isset($this->_post) && $_SESSION["user"]["role"] < 4) { 
                            ?>
