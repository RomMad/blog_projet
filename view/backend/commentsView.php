                    ...
                    <div class="col-md-12 table-responsive">
                        ...
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" class="align-middle">
                                    <a href="index.php?action=comments&orderBy=content&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Contenu du commentaire
                                    <?php 
                                    if ($orderBy == "content") {
                                    ?>
                                ...
                                <th scope="col" class="align-middle">
                                    <a href="index.php?action=comments&orderBy=user_name&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Auteur
                                    <?php 
                                ...
                                <th scope="col" class="align-middle">
                                    <a href="index.php?action=comments&orderBy=status&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Statut
                                    <?php 
                                    if ($orderBy == "status") {
                                    ?>
                                        <span class="fas fa-caret-<?= $order == "desc" ? "up" : "down" ?>"></span>
                                ...
                                <th scope="col" class="align-middle">
                                    <a href="index.php?action=comments&orderBy=report_date&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Date de signalement
                                    <?php 
                                ...
                                <th scope="col" class="align-middle">
                                    <a href="index.php?action=comments&orderBy=nb_report&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Nb de signalements
                                    <?php 
                                ...
                                <th scope="col" class="align-middle">
                                    <a href="index.php?action=comments&orderBy=creation_date&order=<?= $order == "desc" ? "asc" : "desc" ?>" class="sorting-indicator text-white">Date de création
                                    <?php 
