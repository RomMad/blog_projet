...
<html lang="fr">
    ...
    <head>
        ...
        <!-- Scripts TinyMCE -->
        <script src="https://cdn.tiny.cloud/1/002hakdccklcsi43zdvvm0ug6hp1f83dx6abvrs923nlf6ay/tinymce/5/tinymce.min.js"></script>
        <script>
            tinymce.init({
    ...
    <body>
        ...
        <header id="header">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-3 py-3 shadow">
                <a class="navbar-brand text-blue" href="index.php"><?= isset($_SESSION["settings"]) ? $_SESSION["settings"]->blog_name() : "Jean Forteroche | Le blog" ?></a>
